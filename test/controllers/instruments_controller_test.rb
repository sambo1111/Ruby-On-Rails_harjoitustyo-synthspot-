...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { info: @instrument.info, manufacturer_id: @instrument.manufacturer_id, name: @instrument.name, year: @instrument.year }
    end
  ...
  test "should update instrument" do
    patch :update, id: @instrument, instrument: { info: @instrument.info, manufacturer_id: @instrument.manufacturer_id, name: @instrument.name, year: @instrument.year }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
